...
if((i < len)){
var k = (ks[i]);
var G__21674 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),goog.object.get(o,k));
var G__21675 = (i + (1));
m = G__21674;
i = G__21675;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__21677 = c;
var G__21677__$1 = (((G__21677 == null))?null:G__21677.prototype);
if((G__21677__$1 == null)){
return null;
} else {
return G__21677__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__21679 = c;
var G__21679__$1 = (((G__21679 == null))?null:G__21679.prototype);
if((G__21679__$1 == null)){
return null;
} else {
return G__21679__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__21682__delegate = function (args){
...
G__21682.cljs$lang$applyTo = (function (arglist__21684){
var args = cljs.core.seq(arglist__21684);
...
var G__21686 = c;
var G__21686__$1 = (((G__21686 == null))?null:G__21686.constructor);
if((G__21686__$1 == null)){
return null;
} else {
return G__21686__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__21687 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__21688 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__21688);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__21687);
}});
...
var c = this;
var G__21692_21694 = goog.object.get(c,"cljsRatom");
if((G__21692_21694 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__21692_21694);
}
...
var renders_21695 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_21696 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_21695));
...
if((cljs.core.count.call(null,renders_21695) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_21695))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_21696)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.call(null,render_fun_21696)].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__21697 = o;
goog.object.set(G__21697,cljs.core.name.call(null,k),v);
...
//# sourceMappingURL=component.js.map?rel=1708005016818
