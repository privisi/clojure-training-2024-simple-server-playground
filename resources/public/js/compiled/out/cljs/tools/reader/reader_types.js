...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24603 = (function (reader){
...
return m__4429__auto__.call(null,reader);
} else {
var m__4426__auto__ = (cljs.tools.reader.reader_types.read_char["_"]);
if((!((m__4426__auto__ == null)))){
return m__4426__auto__.call(null,reader);
} else {
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24603.call(null,reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24604 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24604.call(null,reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24605 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
var m__4429__auto__ = (cljs.tools.reader.reader_types.unread[goog.typeOf(x__4428__auto__)]);
if((!((m__4429__auto__ == null)))){
return m__4429__auto__.call(null,reader,ch);
} else {
var m__4426__auto__ = (cljs.tools.reader.reader_types.unread["_"]);
if((!((m__4426__auto__ == null)))){
return m__4426__auto__.call(null,reader,ch);
} else {
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24605.call(null,reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24606 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24606.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24607 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24607.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24608 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24608.call(null,reader);
}
});
...
return cljs.core._write.call(null,writer__4370__auto__,"cljs.tools.reader.reader-types/StringReader");
}));
...
return cljs.core._write.call(null,writer__4370__auto__,"cljs.tools.reader.reader-types/NodeReadableReader");
}));
...
return cljs.core._write.call(null,writer__4370__auto__,"cljs.tools.reader.reader-types/PushbackReader");
}));
...
return cljs.core._write.call(null,writer__4370__auto__,"cljs.tools.reader.reader-types/IndexingPushbackReader");
}));
...
return cljs.core._write.call(null,writer__4370__auto__,"cljs.tools.reader.reader-types/SourceLoggingPushbackReader");
}));
...
var G__24619 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
var G__24620 = s.append(c);
c = G__24619;
s = G__24620;
continue;
}
...
//# sourceMappingURL=reader_types.js.map?rel=1708005021996
