...
var G__24752 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24752;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24753 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24753,ch);
...
if(("\\" === ch__$1)){
var ch_24754__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24754__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24754__$2);
} else {
}

var G__24755 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24755;
continue;
}
}
...
var or__4126__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__24763 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24763,(0),null);
var start_column = cljs.core.nth.call(null,vec__24763,(1),null);
...
var G__24766 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24766;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24767 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24768 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24768);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24767);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24769 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24769,(0),null);
var start_column = cljs.core.nth.call(null,vec__24769,(1),null);
...
var vec__24772 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24772,(0),null);
var end_column = cljs.core.nth.call(null,vec__24772,(1),null);
...
var vec__24775 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24775,(0),null);
var start_column = cljs.core.nth.call(null,vec__24775,(1),null);
...
var vec__24778 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24778,(0),null);
var end_column = cljs.core.nth.call(null,vec__24778,(1),null);
...
var vec__24781 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24781,(0),null);
var start_column = cljs.core.nth.call(null,vec__24781,(1),null);
...
var vec__24784 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24784,(0),null);
var end_column = cljs.core.nth.call(null,vec__24784,(1),null);
...
var sb = (function (){var G__24787 = (new goog.string.StringBuffer());
G__24787.append(initch);
...
var G__24789 = (function (){var G__24788 = sb;
G__24788.append(ch);

return G__24788;
})();
var G__24790 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24789;
ch = G__24790;
continue;
}
...
switch (G__24793) {
case "\\":
var G__24797 = (function (){var G__24794 = sb;
G__24794.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24794;
})();
var G__24798 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24797;
ch = G__24798;
continue;
...
break;
default:
var G__24799 = (function (){var G__24795 = sb;
G__24795.append(ch);

return G__24795;
})();
var G__24800 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24799;
ch = G__24800;
continue;
...
var vec__24801 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24801,(0),null);
var end_column = cljs.core.nth.call(null,vec__24801,(1),null);
...
var vec__24804 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24804,(0),null);
var column = cljs.core.nth.call(null,vec__24804,(1),null);
...
var or__4126__auto__ = cljs.tools.reader.resolve_alias.call(null,sym);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var vec__24809 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24809,(0),null);
var column = cljs.core.nth.call(null,vec__24809,(1),null);
...
var vec__24814 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__24814,(0),null);
var column = cljs.core.nth.call(null,vec__24814,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24819 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24819,(0),null);
var start_column = cljs.core.nth.call(null,vec__24819,(1),null);
...
var vec__24822 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24822,(0),null);
var end_column = cljs.core.nth.call(null,vec__24822,(1),null);
...
var G__24825 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24825,true,null,opts,pending_forms);
...
var G__24826 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24826)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24826)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24826)){
...
var _STAR_suppress_read_STAR__orig_val__24827 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24828 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24828);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24827);
}});
...
var G__24829 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24829,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24829,rdr,first_line);

return G__24829;
} else {
var or__4126__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var G__24833 = matched;
var G__24834 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24833;
finished = G__24834;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__4115__auto__ = opts;
if(cljs.core.truth_(and__4115__auto__)){
...
var _STAR_suppress_read_STAR__orig_val__24835 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24836 = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24836);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24835);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24837 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24838 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__24838);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24839 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24839,"(");
...
var G__24840 = (i + (1));
var G__24841 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__24837);
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24842 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24842);
...
var G__24843 = cljs.core.next.call(null,s__$1);
var G__24844 = ret;
s__$1 = G__24843;
r = G__24844;
continue;
...
var G__24845 = cljs.core.next.call(null,s);
var G__24846 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24845;
key_vals = G__24846;
continue;
} else {
...
var or__4126__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
var gensym_env_orig_val__24851 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24852 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__24852);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__24851);
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24853 = token;
var G__24853__$1 = (((G__24853 == null))?null:cljs.core.subs.call(null,G__24853,(1)));
var G__24853__$2 = (((G__24853__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24853__$1));
var G__24853__$3 = (((G__24853__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24853__$2));
var G__24853__$4 = (((G__24853__$3 == null))?null:cljs.core.symbol.call(null,G__24853__$3));
if((G__24853__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24853__$4);
}
})():(function (){var G__24854 = token;
var G__24854__$1 = (((G__24854 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24854));
if((G__24854__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24854__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
var temp__5718__auto__ = (function (){var or__4126__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24865,reader){
var map__24866 = p__24865;
var map__24866__$1 = (((((!((map__24866 == null))))?(((((map__24866.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__24866.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__24866):map__24866);
var opts = map__24866__$1;
var eof = cljs.core.get.call(null,map__24866__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1708005022688
