...
return (new CustomEvent(event_name,(function (){var obj28534 = ({"detail":data});
return obj28534;
})()));
} else {
...
var f = (function (){var pred__28541 = cljs.core._EQ_;
var expr__28542 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28541.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28542))){
return (function (p1__28535_SHARP_){
return console.warn(p1__28535_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28541.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28542))){
return (function (p1__28536_SHARP_){
return console.debug(p1__28536_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28541.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28542))){
return (function (p1__28537_SHARP_){
return console.error(p1__28537_SHARP_);
});
} else {
return (function (p1__28538_SHARP_){
return console.log(p1__28538_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28545){
...
var opts = map__28546__$1;
var eval_fn = cljs.core.get.call(null,map__28546__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28548_SHARP_){
return new_def.callback(p1__28548_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28549){
var vec__28550 = p__28549;
var ky = cljs.core.nth.call(null,vec__28550,(0),null);
...
}catch (e28555){if((e28555 instanceof Error)){
var e = e28555;
return not_found;
} else {
throw e28555;
...
//# sourceMappingURL=utils.js.map?rel=1708005025671
